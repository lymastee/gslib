...
typedef PNG_CALLBACK(void, *png_error_ptr, (png_structp, png_const_charp), PNG_H);
typedef PNG_CALLBACK(void, *png_rw_ptr, (png_structp, png_bytep, png_size_t), PNG_H);
typedef PNG_CALLBACK(void, *png_flush_ptr, (png_structp), PNG_H);
...
typedef PNG_CALLBACK(void, *png_progressive_info_ptr, 
    (png_structp, png_infop), PNG_H);
typedef PNG_CALLBACK(void, *png_progressive_end_ptr,
    (png_structp, png_infop), PNG_H);
typedef PNG_CALLBACK(void, *png_progressive_row_ptr,
    (png_structp, png_bytep, png_uint_32, int), PNG_H);
#endif

#if defined(PNG_READ_USER_TRANSFORM_SUPPORTED) || \
    defined(PNG_WRITE_USER_TRANSFORM_SUPPORTED)
typedef PNG_CALLBACK(void, *png_user_transform_ptr,
    (png_structp, png_row_infop, png_bytep), PNG_H);
#endif

#ifdef PNG_USER_CHUNKS_SUPPORTED
typedef PNG_CALLBACK(int, *png_user_chunk_ptr, (png_structp, 
    png_unknown_chunkp), PNG_H);
#endif
#ifdef PNG_UNKNOWN_CHUNKS_SUPPORTED
typedef PNG_CALLBACK(void, *png_unknown_chunk_ptr, (png_structp), PNG_H);
#endif
...
typedef PNG_CALLBACK(png_voidp, *png_malloc_ptr, (png_structp, 
    png_alloc_size_t), PNG_H);
typedef PNG_CALLBACK(void, *png_free_ptr, (png_structp, png_voidp), PNG_H);
